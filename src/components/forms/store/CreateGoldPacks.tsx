...
import { createSeasonsSchema, CreateSeasonsSchema, CreateSkinsItems, storeItemSchema, StorePacksItems, storePacksSchema, StoreSchema, storeSkinsSchema } from '@/validation/schema'
...
import { useCreatePacksItem, useCreateSkinsItem, useCreateStoreItem } from '@/client_actions/superadmin/store'
  ...
  return (
    ...
    <DialogContent className=' max-w-[600px] h-auto border-amber-500/80 border-[1px] overflow-y-auto max-h-[80%]'>
      <DialogHeader className=' w-full bg-light p-3'>
        <DialogTitle className=' text-sm'>Create Gold Packs</DialogTitle>
        <DialogDescription>
      ...
      <form onSubmit={handleSubmit(createItem)} className=' text-xs flex flex-col gap-2 p-6 '>
            ...
            <Select onValueChange={(value) => setValue("price", Number(value), { shouldValidate: true })}>
                <SelectTrigger className="bg-zinc-950 border-none">
                    <SelectValue placeholder="Price" />
                </SelectTrigger>
                <SelectContent>
                    <SelectItem value="20000">20,000</SelectItem>
                    <SelectItem value="49000">49,000</SelectItem>
                    <SelectItem value="99000">99,000</SelectItem>
                    <SelectItem value="499000">499,000</SelectItem>
                    <SelectItem value="999000">999,000</SelectItem>
                    <SelectItem value="4999000">4,999,000</SelectItem>
                </SelectContent>
            </Select>
