...
import { useResetDailyQuest } from "@/client_actions/superadmin/reset";
...
export default function DailyQuestResetCard({
  id,
  missionName,
  description,
  type,
  ...
  const {mutate: resetDailyQuest, isPending} = useResetDailyQuest()
