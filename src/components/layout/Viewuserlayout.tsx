...
import { ArrowLeft, CircleUser, Equal, Gem, Globe, Home, LogOut, Menu, ShoppingBag, ShoppingBasket, Sword, Swords, User } from 'lucide-react';
import { usePathname, useSearchParams } from 'next/navigation';
import { userRoutes, userViewRoutes } from '@/types/route';
  

export default function Viewuserlayout({
    children,
  }: {
