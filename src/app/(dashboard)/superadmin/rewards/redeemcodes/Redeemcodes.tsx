                ...
                <TableBody>
                    {data?.data.map((item, index) => (
                      ...
                      <TableCell className="font-medium">
                        {(item.itemrewards?.length || item.skillrewards?.length)
                            ? (
                                [...(item.itemrewards ?? []), ...(item.skillrewards ?? [])]
                        ...
                        <TableCell className="text-right flex items-center gap-2">
                            ...
                            <UpdateRedeemCode code={item.code} emerald={item.rewards.exp} coins={item.rewards.coins} crystal={item.rewards.crystal} expiration={item.expiration} id={item.id} itemreward={item.itemrewards} type={item.itemrewards[0]?.inventorytype}/>
                        </TableCell>
                        </TableRow>
                    ))}
