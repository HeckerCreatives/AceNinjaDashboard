...
import EditChestRewards from './EditPackRewards'
import { useGetVipPacks } from '@/client_actions/superadmin/vip-packs'
import EditPackRewards from './EditPackRewards'
...
export default function Packlist() {
    ...
    const {data, isLoading} = useGetVipPacks()
                ...
                <TableBody>
                    {data?.data.map((item, index) => (
                        <TableRow key={item.id}>
                            ...
                            <TableCell>
                                <EditPackRewards data={item}/>
                            </TableCell>
                            <TableCell className=' flex items-center gap-2'>
                                <EditPack id={item.id} data={item}/>
