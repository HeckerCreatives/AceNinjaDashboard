  ...
  return (
    <div className=' w-full max-w-[1540px] h-auto flex flex-col gap-6 items-center p-4'>
        ...
        <div className=' w-full grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] lg:grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-6'>
            <ViewCard name={'Coins'} value={data?.wallet[1].amount || 0} isAmount={false} icon={currencyCardImg('coins')} isLoading={true} bg={'bg-[#531414]'} border={true}/>
            <ViewCard name={'Crystal'} value={data?.wallet[2].amount || 0} isAmount={false} icon={currencyCardImg('crystal')} isLoading={true} bg={'bg-[#531414]'} border={true}/>
            <ViewCard name={'Credits'} value={data?.wallet[0].amount || 0} isAmount={false} icon={currencyCardImg('topupcredit')} isLoading={true} bg={'bg-[#531414]'} border={true}/>
