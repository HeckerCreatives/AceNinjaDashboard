...
import { useGetStoryHistory, useGetStoryHistoryAdmin } from '@/client_actions/superadmin/story'
...
export default function StoryHistory() {
  ...
  const {data, isLoading} = useGetStoryHistory(characterid, filter === 'all' ? '' : filter , currentPage, 10)
